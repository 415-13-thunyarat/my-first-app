...
#ส่วนที่ 4 แปลงผลค่า BMI ตามเกณฑ์
 if bmi < 18.5:
     st.warning("⚠️ คุณมีน้ำหนักน้อยกว่าเกณฑ์ (ผอม)")
      ...
      st.sueecss("⭐ ตุณมีน้ำหนักอยู่ในเกณฑ์ปกติ (สุขภาพดี)")
 elif 23.0 <= bmi < 25.0: 
      st.info("📏 คุณเริ่มมีน้ำหนักเกินเกณฑ์ (ท้วม)")
 else:
      st.error(🚨 คุณอยู่ในเกณฑ์อ้วน ควนระวังเรื่องสุขภาพและออกกำลังกาย)

st.divider()
st.write("นางสาว ธัญญรัตน์ ปัญญานะ เลขที่13 ม.4/15")
